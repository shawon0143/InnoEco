...
class MyEvents extends React.Component<Props, IState> {
    ...
    onCreateEvent = () => {
        console.log(this.state.createEventForm);
        ...
        if (this.state.formIsValid) {
            ...
            this.setState({errorMsg: 'Please enter name and descrition of event.'});
        }
    }
